...
<body <?php body_class(); ?>  style="background:url('<?php echo get_template_directory_uri(); ?>/img/body-bg7.png')">
<div id="page" class="hfeed site">
	...
	<?php } ?>	
		...
		<?php else : ?>
		<div class="header-ycma">
			<h1>
				<a class="site-description">
					<img src="<?php echo get_template_directory_uri(); ?>/img/Chapeau.jpg" />
				</a>
			</h1>
		</div>
	<?php if( get_theme_mod( 'iconic_one_social_activate' ) == '1') { ?>
	...
	<div>
		<?php if( function_exists('bxslider') ) bxslider('my-slider'); ?>
	</div>
